...
ax.plot([0], [1], linewidth=2, color=col1, **marker2, clip_on=False, zorder=3, label='optimal bound')
...
#ax.plot([0, 0,   1/r7, 1/r7,  1/r5,  1/r5, 1/r3, 1/r3, 2/r6, 2/r6, 1,    1, 2],
#        [1, 1/2, 1/2,  29/64, 29/64, 3/8,  3/8,  1/4,  1/4,  7/32, 7/32, 0, 0])
ax.set_xlim(0, xmax)
ax.set_ylim(0, 1)
