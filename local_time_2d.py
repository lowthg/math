...
ax.plot3D([Xmax, Xmax, Xmin, Xmin, Xmax, Xmax], [0, times[-1], times[-1], 0, 0, 0], [zmax, zmax, zmax, zmax, zmax, 0], color='grey', alpha=0.5, zorder=20)
ax.view_init(35, -74)
ax.set_xticklabels([])
ax.set_yticklabels([])
ax.set_zticklabels([])
...
ax.set_xlim3d(Xmin + 0.016 * width, Xmax - 0.015 * width)
ax.set_ylim3d(0, times[-1] * 0.95)
ax.set_zlim3d(0, zmax * 0.99)
